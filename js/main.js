...
const translations = {
  en: {
    ...
    /* projects */
    'p1-client':  'Architecture & Interior Design · Bahrain',
    'p1-title':   'PAD',
    'p1-desc':    'A refined portfolio site for an architecture and interior design studio — built to showcase projects and attract discerning clients.',
    'p1-link':    'View Live →',

    'p2-client':  'Real Estate Media · Bahrain',
    'p2-title':   'PanoPros',
    'p2-desc':    "Professional photography, videography, virtual tours, floor plans, and virtual staging for Bahrain's property market.",
    'p2-link':    'View Live →',

    'p3-client':  'Hair, Nails & Café · Barbar, Bahrain',
    'p3-title':   'Mélo Beauty Lounge',
    'p3-desc':    'Full-service salon with an in-house café — hair colour, treatments, manicures, and pedicures in Barbar, Bahrain.',
    'p3-link':    'View Live →',

    'p4-client':  'Wellness & Beauty · Bahrain',
    'p4-title':   'Calma',
    'p4-desc':    'A serene, conversion-focused site for a premium wellness brand — designed to attract and book clients effortlessly.',
    'p4-link':    'View Live →',
    ...
    'p6-client':  'Premium Car Care · Bahrain',
    'p6-title':   'CAS Premium',
    'p6-desc':    'High-end auto detailing, ceramic coatings, and PPF — a premium site built to attract serious car enthusiasts.',
    'p6-link':    'View Live →',

    'p7-client':  'Auto Detailing · Salmabad, Bahrain',
    'p7-title':   'Custom Touch Car Care',
    'p7-desc':    'Workshop-grade detailing — ceramic coatings, PPF, wrapping, and paint correction built for Gulf conditions.',
    'p7-link':    'View Live →',

    'p8-client':  'Car Detailing · Hidd, Bahrain',
    'p8-title':   '3D Car Spa',
    'p8-desc':    'Premium mobile car detailing with a spa-quality finish — comes to you anywhere in Bahrain.',
    'p8-link':    'View Live →',

    'coming-soon-eyebrow': 'Next Project',
    'coming-soon-text':    'Coming Soon',
    'p9-client':  'Your Business · Bahrain',
    'p9-title':   'More projects launching soon',
    'p9-desc':    'New client work in progress. Want to see your business here?',
    'p9-link':    'Get in Touch →',
  ...
  ar: {
    ...
    /* projects */
    'p1-client':  'هندسة معمارية وتصميم داخلي · البحرين',
    'p1-title':   'PAD',
    'p1-desc':    'موقع محكم لاستوديو هندسة معمارية وتصميم داخلي — مصمم لعرض المشاريع واستقطاب العملاء المميزين.',
    'p1-link':    '← عرض مباشر',

    'p2-client':  'إعلام عقاري · البحرين',
    'p2-title':   'PanoPros',
    'p2-desc':    'تصوير احترافي، مقاطع فيديو، جولات افتراضية، مخططات طابقية، وتأثيث افتراضي لسوق العقارات في البحرين.',
    'p2-link':    '← عرض مباشر',

    'p3-client':  'صالون شعر وأظافر وكافيه · بربار، البحرين',
    'p3-title':   'Mélo Beauty Lounge',
    'p3-desc':    'صالون متكامل مع كافيه داخلي — صبغ شعر، علاجات، مانيكير، وباديكير في بربار، البحرين.',
    'p3-link':    '← عرض مباشر',

    'p4-client':  'صحة وجمال · البحرين',
    'p4-title':   'Calma',
    'p4-desc':    'موقع هادئ ومحفز للتحويل لعلامة تجارية فاخرة في مجال الصحة — مصمم لجذب العملاء وحجز مواعيدهم بسهولة.',
    'p4-link':    '← عرض مباشر',
    ...
    'p6-client':  'عناية فاخرة بالسيارات · البحرين',
    'p6-title':   'CAS Premium',
    'p6-desc':    'تفصيل سيارات راقٍ، طلاءات سيراميك، وحماية PPF — موقع فاخر مصمم لاستقطاب عشاق السيارات الجادين.',
    'p6-link':    '← عرض مباشر',

    'p7-client':  'تفصيل سيارات · سلماباد، البحرين',
    'p7-title':   'Custom Touch Car Care',
    'p7-desc':    'تفصيل احترافي بمستوى الورشة — طلاءات سيراميك، PPF، تغليف، وتصحيح طلاء مصمم لظروف الخليج.',
    'p7-link':    '← عرض مباشر',

    'p8-client':  'تفصيل سيارات · حد، البحرين',
    'p8-title':   '3D Car Spa',
    'p8-desc':    'تفصيل سيارات متنقل بجودة سبا فاخرة — يصل إليك في أي مكان في البحرين.',
    'p8-link':    '← عرض مباشر',

    'coming-soon-eyebrow': 'المشروع القادم',
    'coming-soon-text':    'قريبًا',
    'p9-client':  'عملك · البحرين',
    'p9-title':   'المزيد من المشاريع قادمة',
    'p9-desc':    'أعمال جديدة قيد الإنجاز. هل تريد رؤية عملك هنا؟',
    'p9-link':    '← تواصل معنا',
