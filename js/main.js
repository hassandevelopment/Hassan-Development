...
const translations = {
  en: {
    ...
    'p3-client':  'Wellness & Beauty · Bahrain',
    'p3-title':   'Calma',
    'p3-desc':    'A serene, conversion-focused site for a premium wellness brand — designed to attract and book clients effortlessly.',
    'p3-link':    'View Live →',

    'p4-client':  'Italian Restaurant · Bahrain',
    'p4-title':   'Gusto Pizzeria Ristorante',
    'p4-desc':    'Authentic wood-fired Italian dining — a full-service restaurant site built to drive reservations.',
    'p4-link':    'View Live →',

    'p5-client':  'Premium Car Care · Bahrain',
    'p5-title':   'CAS Premium',
    'p5-desc':    'High-end auto detailing, ceramic coatings, and PPF — a premium site built to attract serious car enthusiasts.',
    'p5-link':    'View Live →',

    'p6-client':  'Auto Detailing · Salmabad, Bahrain',
    'p6-title':   'Custom Touch Car Care',
    'p6-desc':    'Workshop-grade detailing — ceramic coatings, PPF, wrapping, and paint correction built for Gulf conditions.',
    'p6-link':    'View Live →',

    'p7-client':  'Car Detailing · Hidd, Bahrain',
    'p7-title':   '3D Car Spa',
    'p7-desc':    'Premium mobile car detailing with a spa-quality finish — comes to you anywhere in Bahrain.',
    'p7-link':    'View Live →',
  ...
  ar: {
    ...
    'p3-client':  'صحة وجمال · البحرين',
    'p3-title':   'Calma',
    'p3-desc':    'موقع هادئ ومحفز للتحويل لعلامة تجارية فاخرة في مجال الصحة — مصمم لجذب العملاء وحجز مواعيدهم بسهولة.',
    'p3-link':    '← عرض مباشر',

    'p4-client':  'مطعم إيطالي · البحرين',
    'p4-title':   'Gusto Pizzeria Ristorante',
    'p4-desc':    'مطعم إيطالي أصيل بالفرن الحطبي — موقع متكامل مصمم لزيادة الحجوزات.',
    'p4-link':    '← عرض مباشر',

    'p5-client':  'عناية فاخرة بالسيارات · البحرين',
    'p5-title':   'CAS Premium',
    'p5-desc':    'تفصيل سيارات راقٍ، طلاءات سيراميك، وحماية PPF — موقع فاخر مصمم لاستقطاب عشاق السيارات الجادين.',
    'p5-link':    '← عرض مباشر',

    'p6-client':  'تفصيل سيارات · سلماباد، البحرين',
    'p6-title':   'Custom Touch Car Care',
    'p6-desc':    'تفصيل احترافي بمستوى الورشة — طلاءات سيراميك، PPF، تغليف، وتصحيح طلاء مصمم لظروف الخليج.',
    'p6-link':    '← عرض مباشر',

    'p7-client':  'تفصيل سيارات · حد، البحرين',
    'p7-title':   '3D Car Spa',
    'p7-desc':    'تفصيل سيارات متنقل بجودة سبا فاخرة — يصل إليك في أي مكان في البحرين.',
    'p7-link':    '← عرض مباشر',
